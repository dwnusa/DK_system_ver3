...
$ENV{'SYSGEN'} = 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 1912.000244140625,
    'generating_subsystem_handle' => 1912.000244140625,
    ...
    'isdeployed' => 0,
    'ise_version' => '14.7i',
    'master_sysgen_token_handle' => 1913.0001220703125,
    'matlab' => 'C:/Program Files/MATLAB/R2013b',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 1912.000244140625,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    'sg_version' => '',
    'sggui_pos' => '-1,-1,-1,-1',
    'simulation_island_subsystem_handle' => 1912.000244140625,
...
fprintf(\'\',\'COMMENT: end icon text\');',
  ...
  $instrs = {
    'entity_declaration_hash' => '9624eec585644441235c2277fee067d6',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '86e22b1d6da0f9a0086735bd1036fcb4',
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'a0f50d00effa775f8c9e7dabda9b98f8',
    'sourceFile' => 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd9781a699e8e3633c908fd9fe0c98c17',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_97b5175c82',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b333a8627273e2e8e90f04147bc69dbc',
    'sourceFile' => 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '660ba756c3573aee59dc0adea78a3809',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_1_31: signed((16 - 1) downto 0);
...
begin
  ...
  cast_18_16 <= s2s_cast(b_1_34, 0, 16, 0);
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_b85573c9cd',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '3df8fb4da767696f37b3c6d7527997cd',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  begin
    case sel_internal_2_1_convert is 
      ...
      when others =>
        unregy_join_6_1 <= cast(d1_1_27, 0, 16, 0, xlSigned);
    end case;
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'mux_1c0f59dbb1',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '25982635e30150dc83f809180960f13d',
    'sourceFile' => 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c2d815b5e64f9037c0ae0a670972da91',
    'sourceFile' => 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen';
  open(RESULTS, '> C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results4421736418379386554') || 
    croak 'couldn\'t open C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results4421736418379386554';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results4421736418379386554';
};
