...
$ENV{'SYSGEN'} = 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/Users/ROBOT3~1/AppData/Local/Temp/sysgentmp-Robot32-VM/cg_wk/c2587127732d78fd0',
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '5947b56a5406c344b7c776d3f125fe6c',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  $instrs = [
    ...
    'CSET sync_threshold_output = false',
    'CSET syncctrlpriority = Reset_Overrides_Set',
    'CSET component_name = cntr_11_0_63594e4e10f743b9',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4f3bfd547775ce6801b7232dfce94f6e',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/14.7/ISE_DS/ISE/sysgen';
  open(RESULTS, '> C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results8731726451617583207') || 
    croak 'couldn\'t open C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results8731726451617583207';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing C:/Users/Robot32-VM/Documents/System Generator/11_Gamma_Simple/1_HDL_Netlist/sysgen/script_results8731726451617583207';
};
